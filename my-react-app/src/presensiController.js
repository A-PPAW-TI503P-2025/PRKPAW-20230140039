...
// Tambahkan ini di dalam controllers/presensiController.js

exports.deletePresensi = async (req, res) => {
  try {
    const { id: userId } = req.user; // Ambil ID user dari token
    const presensiId = req.params.id; // Ambil ID presensi dari URL
    ...
    // (Opsional) Cek apakah yang menghapus adalah pemilik data atau admin
    // Jika Anda ingin admin bisa menghapus semua, tambahkan logika cek role di sini.
    // Saat ini kita batasi hanya pemilik yang bisa menghapus.
    if (recordToDelete.userId !== userId) {
